...
const Work = () => {
  return (
    ...
    <div id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        <h2 className=' text-center text-5xl font-Ovo'>Algunos proyectos</h2>

        <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
        ¡Bienvenido a mi portafolio de desarrollo! Explora proyectos que reflejan mis conocimientos en desarrollo y tecnología.</p>
            ...
            {workData.map((project, index )=>(
                <div className='aspect-square bg-no-repeat bg-cover bg-center rounded-lg relative cursor-pointer group'
                 key={ index } style={{backgroundImage: `url(${project.bgImage})`}}>
                    ...
                    justify-between group-hover:bottom-7 duration-500'>
                        <div>
        ...
        py-3 px-10 mx-auto my-20 hover:bg-ligthHover duration-500 '>Ver Mas <Image src={assets.right_arrow_bold} alt='Right arrow' className='w-4'/> </a>
